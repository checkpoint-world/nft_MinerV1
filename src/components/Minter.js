...
const Minter = (props) => {
  ...
  const onSubmitDialog = async () => {
    setLoading(true);
    const response = await mintNFT(limit, walletAddress);
    setResponse(response);
    handleClose();
    setLoading(false);
  }
                      ...
                      <TableBody>
                        ...
                        >
                          <TableCell component="th" scope="row">
                            1 NFTc (claimable NFT)
                          </TableCell>
                          <TableCell align="right">{nftMetaData.AMOUNT_PER_UNIT} {nftMetaData.SYMBOL}</TableCell>
                           </TableRow>
                        {/* <TableRow
                          sx={{ '&:last-child td, &:last-child th': { border: 0 } }}
                        >
                          ...
                          <TableCell align="right">{nftMetaData.MAX_GENERATED} {nftMetaData.SYMBOL}</TableCell>
                        </TableRow> */}
                        <TableRow
                            sx={{ '&:last-child td, &:last-child th': { border: 0 } }}
                        >
                          <TableCell component="th" scope="row">
                            ...
                            <TableCell align="right">{nftMetaData.GENERATED} / {nftMetaData.MAX_GENERATED} NFTc</TableCell>
                        ...
                        >
                          {
                            Array(parseInt(nftMetaData.LIMIT_PER_TRASAC)).fill(1).map((value, index) => (
                              <MenuItem key={index} value={value + index}>{value + index}</MenuItem>
                            ))
                          }
                        </Select>
                      </FormControl>
                  ...
                  <DialogContent>
                    ...
                    >
                      <Stack spacing={3} direction='column'>
                        <Typography>
                          You are going to mint {limit}X NFT for a total of: {nftMetaData.AMOUNT_PER_UNIT * limit} {nftMetaData.SYMBOL}
                        </Typography>
                        {/* <FormControl>
